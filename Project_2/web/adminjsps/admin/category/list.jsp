...
<style type="text/css">
  ...
  <body>
    ...
    <table align="center" border="1" cellpadding="0" cellspacing="0">
		...
		<c:forEach var="catefory" items="${requestScope.aCategory}">
			<tr bordercolor="rgb(78,78,78)">
				<td>${catefory.cname}</td>
				<td>
					<a href="<c:url value='/adminjsps/admin/category/mod.jsp?cid=${catefory.cid}&cname=${catefory.cname}'/>">修改</a> |
					<a href="<c:url value='/adminjsps/admin/category/del.jsp?cid=${catefory.cid}&cname=${catefory.cname}'/>">删除</a>
				</td>
			</tr>
		</c:forEach>
