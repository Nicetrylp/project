...
function load() {
	...
	bar1.add("分类管理", "查看分类", "<c:url value='/aCategory?method=lookCategory'/>", "body");
	bar1.add("分类管理", "添加分类", "<c:url value='/adminjsps/admin/category/add.jsp'/>", "body");

	bar1.add("图书管理", "查看图书", "<c:url value='/aBook?method=lookAllBook'/>", "body");
	bar1.add("图书管理", "添加图书", "<c:url value='/aBook?method=loadCategory'/>", "body");
